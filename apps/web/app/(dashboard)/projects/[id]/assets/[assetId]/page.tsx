    ...
    <div className="absolute inset-0 flex flex-col overflow-hidden">
      ...
      <div className="flex items-center justify-between border-b border-border px-3 h-12 bg-bg-secondary shrink-0">
        ...
        <div className="flex items-center gap-2 shrink-0 flex-1 justify-end">
          ...
          <div className="hidden md:block"><ShareDialog assetId={asset.id} assetName={asset.name} projectId={projectId} asset={asset} /></div>
          <button
      ...
      <div className="relative flex flex-1 overflow-hidden min-h-0">
        ...
        {sidebarOpen && (
          <div className="absolute inset-y-0 right-0 z-30 flex w-full max-w-[360px] flex-col border-l border-border bg-bg-secondary shadow-2xl animate-in slide-in-from-right-2 duration-150 md:static md:z-auto md:shrink-0 md:shadow-none">
