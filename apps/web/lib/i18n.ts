...
const baseMessages = {
  ...
  'device.authorizeTitle': ['Authorize Adobe Premiere', 'Разрешить Adobe Premiere'],
  'device.description': ['Confirm access for the Premiere extension signed in to this browser.', 'Подтвердите доступ для расширения Premiere, авторизованного в этом браузере.'],
  'device.code': ['Device code', 'Код устройства'],
  'device.codePlaceholder': ['ABCD-EFGH', 'ABCD-EFGH'],
  'device.approve': ['Approve Premiere access', 'Разрешить доступ Premiere'],
  'device.approved': ['Premiere access approved. You can return to the extension.', 'Доступ Premiere разрешён. Можно вернуться в расширение.'],
  'device.invalid': ['This device code is invalid or has expired.', 'Код устройства недействителен или истёк.'],
  'device.checkingSession': ['Checking browser session…', 'Проверяем сессию браузера…'],
