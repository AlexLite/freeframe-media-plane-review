...
const russianUi: Record<string, string> = {
  ...
  'Custom title': 'Свой заголовок',
  'My Project Hub': 'Страница проекта',
  'Custom footer': 'Свой текст внизу страницы',
  'Confidential — do not distribute': 'Конфиденциально — не распространять',
  'Featured field': 'Выделенное поле',
  'Custom metadata field name': 'Название поля метаданных',
  'Viewer layout': 'Вид страницы просмотра',
  'Grid': 'Плитка',
  'Reel': 'Лента',
  'Save branding': 'Сохранить оформление',
  'Branding saved.': 'Оформление сохранено.',
  'Logo upload failed.': 'Не удалось загрузить логотип.',
  'Metadata Fields': 'Поля метаданных',
  'Define custom fields for assets in this project.': 'Добавьте собственные поля для материалов этого проекта.',
  'Add Field': 'Добавить поле',
  'No custom fields yet.': 'Собственных полей пока нет.',
  'Add Metadata Field': 'Добавить поле метаданных',
  ...
  'Options (comma separated)': 'Варианты через запятую',
  'Option 1, Option 2, Option 3': 'Вариант 1, Вариант 2, Вариант 3',
  ...
  'PNG with a transparent background, up to 10 MB.': 'PNG с прозрачным фоном, не более 10 МБ.',
  'Watermark preview': 'Предпросмотр водяного знака',
  'Upload PNG': 'Загрузить PNG',
  'Replace PNG': 'Заменить PNG',
  'Use a PNG image.': 'Выберите изображение в формате PNG.',
  'The image must be smaller than 10 MB.': 'Размер изображения должен быть меньше 10 МБ.',
  'Watermark image uploaded.': 'Изображение водяного знака загружено.',
